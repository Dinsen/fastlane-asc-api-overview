...
| TestFlight | ❌    | GET    | builds/{id}/appEncryptionDeclaration               |
...
| TestFlight | ❌    | GET    | builds/{id}/icons                                  |
| TestFlight | ❌    | GET    | builds/{id}/relationships/individualTesters        |
| TestFlight | ❌    | POST   | builds/{id}/relationships/individualTesters        |
| TestFlight | ❌    | DELETE | builds/{id}/relationships/individualTesters        |
| TestFlight | ❌    | GET    | builds/{id}/individualTesters                      |
| TestFlight | ❌    | GET    | builds/{id}/perfPowerMetrics                       |
| TestFlight | ❌    | GET    | builds/{id}/preReleaseVersion                      |
</details>
